describe('Department data selection' , function(){
    ...
    it('The Most Profitable Department with "salesData"' , function(){     
       assert.equal('outdoor', mostProfitableDepartment(salesData));
    });

    it('The most Profitable Department with "salesData2"' , function(){    
        assert.equal('electronics', mostProfitableDepartment(salesData2));
     });

     it('The Most ProfitableDay "salesData"' , function(){
        assert.equal('Thursday', mostProfitableDay(salesData));
     });

     it('The MostProfitable Day "salesData2"' , function(){
